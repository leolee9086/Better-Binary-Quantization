 ...
 * @returns 点积结果
 */
export function computeInt4BitDotProductBitwise(q: Uint8Array, d: Uint8Array): number {
 ...
 * @returns 点积结果
 */
export function computeInt1BitDotProductBitwise(q: Uint8Array, d: Uint8Array): number {
